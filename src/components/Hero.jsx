...
import resume from '../assets/Pavan_Rai_Resume.pdf';
  ...
  return (
    <section id="home" className="hero fade-in">
      <div className="container">
        <h1 className="reveal-text">Hi, I'm Pavan rai</h1>
        ...
        <div style={{ marginTop: '2rem', display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <a href={resume} download="Pavan_Rai_Resume.pdf" className="btn btn-outline">Download Resume</a>
